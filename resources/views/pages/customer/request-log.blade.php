        ...
        <form method="GET">
            <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                <div class="w-full xl:w-56 relative text-gray-700 dark:text-gray-300">
                    <input id="myInput" onkeyup="myFunction()"  type="text" name="search" value="{{ request()->get('search') }}" class="input w-full xl:w-56 box pr-10 placeholder-theme-13" style="padding:10px; border-radius: 20px;" placeholder="Search...">
                ...
                <div class="modal" id="view{{$data->id}}">
                    <div class="modal__content modal__content--lg p-5">
                            ...
                            <div class="p-5 grid grid-cols-12 gap-4 row-gap-3">
                                ...
                                <div class="col-span-12">
                                    <label>Plumber</label>
                                    <input type="text" class="input w-full border mt-2 flex-1" value="{{$data->technician->name ?? 'Waiting for plumber assigned'}}" readonly>
                                </div>
                            </div>
