    ...
    <table class="table table-report sm:mt-2">
            ...
            <tbody>
                ...
                <tr>
                    <td class="w-40">
                        <div class="flex">
                            {{Carbon\Carbon::parse($data->updated_at)->format('M d, Y') ?? 'N/A'}}
                        </div>
                    </td>
                    ...
                    <td class="w-40">
                        <div class="flex {{($data->priority == 'High')? 'text-red-500' : ($data->priority == 'Medium' ? 'text-orange-500' : 'text-green-500')}}">
                            {{$data->priority ?? 'N/A'}}
                        </div>
                    </td>
                    ...
                    <td class="w-40">
                        <div class="flex">
                            ...
                            <a href="{{route('workorder.assetListTech',$data->id)}}"
                                class="view-dialog rounded-md p-1 w-35 text-white bg-theme-1 hover:bg-blue-400 xl:mr-3 flex">
