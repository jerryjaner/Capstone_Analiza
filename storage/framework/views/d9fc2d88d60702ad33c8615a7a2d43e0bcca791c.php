...
} elseif ($_instance->childHasBeenRendered('8HtISVz')) {
    $componentId = $_instance->getRenderedChildComponentId('8HtISVz');
    $componentTag = $_instance->getRenderedChildComponentTagName('8HtISVz');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('8HtISVz');
} else {
    $response = \Livewire\Livewire::mount('service-selection', []);
    $html = $response->html();
    $_instance->logRenderedChild('8HtISVz', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layouts.customer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\th_developer\Desktop\Capstone_Analiza\resources\views/pages/customer/submit-request.blade.php ENDPATH**/ ?>