...
<nav class="side-nav">
    ...
    <ul>
        ...
        <li>
            <a href="<?php echo e(route('assigned.index')); ?>" class="side-menu <?php echo e((!request()->routeIs('assigned.index'))?'bg-theme-1':'bg-blue-500'); ?>">
        ...
        <li>
            <a href="<?php echo e(route('profile.tech_show_changepw')); ?>"  class="side-menu <?php echo e((!request()->routeIs('profile.tech_show_changepw'))?'bg-theme-1':'bg-blue-500'); ?>">
...
<?php /**PATH C:\Users\Admin\Desktop\Capstone_Analiza\resources\views/layouts/partials/technician/side-nav.blade.php ENDPATH**/ ?>