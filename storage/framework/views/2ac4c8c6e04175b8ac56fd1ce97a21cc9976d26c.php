                ...
                <tr>
                    ...
                    <td class="w-40">
                        <div class="flex">
                            ...
                            <a href="<?php echo e(route('workorder.assetList',$data->id)); ?>"
                                class="view-dialog rounded-md p-1 w-35 text-white bg-theme-1 hover:bg-blue-400 xl:mr-3 flex">
                            ...
                            <a href="javascript:;"
                                data-toggle="modal"
                                data-target="#edit<?php echo e($data->id); ?>"
                                class="view-dialog rounded-md p-1 w-35 text-white bg-theme-1 hover:bg-blue-400 xl:mr-3 flex">
...
<?php echo $__env->make('layouts.staff', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\th_developer\Desktop\Capstone_Analiza\resources\views/pages/staff/work-order.blade.php ENDPATH**/ ?>