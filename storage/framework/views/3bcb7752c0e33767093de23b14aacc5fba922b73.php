        ...
        <div class="intro-x text-center xl:text-left">
            ...
            <div class="modal" id="add">
                <div class="modal__content">
                    ...
                    <form action="<?php echo e(route('asset.store')); ?>" method="POST" enctype="multipart/form-data" id="assetForm">
                        <?php echo csrf_field(); ?>
                        <div class="p-5 grid grid-cols-12 gap-4 row-gap-3">
                            ...
                            <div class="col-span-12 sm:col-span-12">
                                ...
                                <select name="unit" id="unit" class="input w-full border mt-2 flex-1 <?php $__errorArgs = ['unit'];
...
<div class="col-span-12 lg:col-span-6">
    <div class="intro-y overflow-auto xxxl:overflow-visible sm:mt-8">
        <table class="table table-report sm:mt-2">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $assets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="intro-x">
                        <td class="w-40">
                            <p class="text-xs"><?php echo e($data->materials); ?></p>
                        </td>
                        <td class="w-40">
                            <p class="text-xs"><?php echo e($data->unit); ?></p>
                        </td>
                        <td class="w-40">
                            <p class="text-xs"><?php echo e($data->unit_price); ?></p>
                        </td>
                        <td class="w-40">
                            <p class="text-xs"><?php echo e($data->unit_cost_lbc); ?></p>
                        </td>
                        <td class="w-40">
                            <div class="flex">
                    ...
                    <div class="modal" id="delete<?php echo e($data->id); ?>">
                        <div class="modal__content">
                            <form action="<?php echo e(route('asset.delete',$data->id)); ?>" method="post">
                                <?php echo csrf_field(); ?>
                    ...
                    <div class="modal" id="edit<?php echo e($data->id); ?>">
                        <div class="modal__content">
                            ...
                            <form action="<?php echo e(route('asset.update',$data->id)); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PUT'); ?>
                                <div class="p-5 grid grid-cols-12 gap-4 row-gap-3">
                                    <div class="col-span-12 sm:col-span-12">
                                        <label for="material">Material Name :</label>
                                        <textarea name="material" id="material" cols="30" class="input w-full" rows="4" required=""><?php echo e($data->materials); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" required>
                                    ...
                                    <div class="col-span-12 sm:col-span-12">
                                        <label for="unit_price">Unit Price :</label>
                                        <input type="number" name="unit_price" class="input w-full" id="unit_price" value="<?php echo e($data->unit_price); ?>">
                                    </div>

                                    <div class="col-span-12 sm:col-span-12">
                                        <label for="unit_cost_lbc">Labor Charges/Unit Cost :</label>
                                        <input type="number" name="unit_cost_lbc" class="input w-full" id="unit_cost_lbc" value="<?php echo e($data->unit_cost_lbc); ?>">
                                    </div>
                                </div>
                                <div class="px-5 py-3 text-right border-t border-gray-200 dark:border-dark-5">
                                    <button type="button" data-dismiss="modal" class="button w-20 border text-gray-700 dark:border-dark-5 dark:text-gray-300 mr-1">Cancel</button>
...
<?php echo $__env->make('layouts.staff', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Desktop\Capstone_Analiza\resources\views/pages/staff/assets.blade.php ENDPATH**/ ?>