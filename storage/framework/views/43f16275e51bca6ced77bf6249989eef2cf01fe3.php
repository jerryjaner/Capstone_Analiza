...
<div class="col-span-12 lg:col-span-6">
    <div class="intro-y overflow-auto xxxl:overflow-visible">
        <table class="table table-report sm:mt-2">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $request_log->where('status', 'Inprocess'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr class="intro-x">
                    <td class="w-10">
                        <div class="flex">
...
<?php echo $__env->make('../layouts.customer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\th_developer\Desktop\Capstone_Analiza\resources\views/pages/customer/request-process.blade.php ENDPATH**/ ?>