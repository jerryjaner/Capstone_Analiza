    ...
    <div class="messenger-listView <?php echo e(!!$id ? 'conversation-active' : ''); ?>">
        ...
        <div class="m-body contacts-container">
           ...
           <?php if(auth()->user()->role == '1' || auth()->user()->role == '3'): ?>
            ...
            <?php else: ?>
            <div class="show messenger-tab users-tab app-scroll" style="margin-top:-70px;" data-view="users">
...
<?php /**PATH C:\Users\Admin\Desktop\Capstone_Analiza\resources\views/vendor/Chatify/pages/app.blade.php ENDPATH**/ ?>