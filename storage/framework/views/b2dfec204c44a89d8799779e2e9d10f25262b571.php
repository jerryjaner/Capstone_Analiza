...
<div class="mx-auto text-gray-600 intro-y col-span-12 flex flex-wrap sm:flex-no-wrap items-center justify-center mt-2">
    <form method="GET" class="p-5 grid grid-cols-12 gap-4 row-gap-1">
        ...
        <div class="col-span-6 sm:col-span-3">
            <a href="<?php echo e(route('sell.index')); ?>" class="button button--lg rounded-md p-2 w-full  mx-auto text-white bg-theme-9 hover:bg-green-400 flex">Refresh</a>
        </div>
    </form>
</div>
...
<?php echo $__env->make('../../layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Desktop\Capstone_Analiza\resources\views/pages/admin/report/sell.blade.php ENDPATH**/ ?>