...
<nav class="side-nav">
    ...
    <ul>
        ...
        <li>
            <a href="<?php echo e(route('profile.show_changepw')); ?>"  class="side-menu <?php echo e((!request()->routeIs('profile.show_changepw'))?'bg-theme-1':'bg-blue-500'); ?>">
...
<?php /**PATH C:\Users\Admin\Desktop\Capstone_Analiza\resources\views/layouts/partials/customer/side-nav.blade.php ENDPATH**/ ?>