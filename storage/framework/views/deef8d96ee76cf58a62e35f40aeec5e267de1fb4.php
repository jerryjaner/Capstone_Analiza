<div class="top-bar">
    <div class="intro-x breadcrumb mr-auto sm:flex"> <a href="" class="">Application</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active"><?php echo $__env->yieldContent('breadcrumbs'); ?></a> </div>
        ...
        <div class="dropdown-box w-56">
            <div class="dropdown-box__content box bg-theme-1 dark:bg-dark-6 text-white">
                <div class="p-4 border-b border-theme-35 dark:border-dark-3">
                    ...
                    <div class="text-xs text-theme-41 dark:text-gray-600"><?php echo e(auth()->user()->email); ?></div>
                </div>
...
</div><?php /**PATH C:\Users\th_developer\Desktop\Capstone_Analiza\resources\views/layouts/partials/customer/top-bar.blade.php ENDPATH**/ ?>