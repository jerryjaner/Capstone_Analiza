...
<div class="modal" id="add">
    <div class="modal__content modal__content--xl p-5">
        ...
        <form action="<?php echo e(route('technician.store')); ?>" name="addForm" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="p-5 grid grid-cols-12 gap-4 row-gap-3">
...
<div class="modal" id="edit">
    <div class="modal__content modal__content--xl p-5">
        ...
        <form action="<?php echo e(route('technician.update')); ?>" name="editForm" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <?php echo method_field('PUT'); ?>
            <div class="p-5 grid grid-cols-12 gap-4 row-gap-3">
                <input type="hidden" name="id" id="id" />
...
<div class="modal" id="delete">
    <div class="modal__content">
        <form action="<?php echo e(route('technician.delete')); ?>" method="post">
            <?php echo csrf_field(); ?>
...
</div><?php /**PATH C:\Users\Admin\Desktop\Analiza_Capstone\resources\views/components/technician-modal.blade.php ENDPATH**/ ?>